...
const DEMO_ACCOUNTS: DemoAccount[] = [
  {
    role: 'Admin',
    title: 'Super Admin (Aarav Sharma)',
    email: 'admin@peoplepay360.demo',
    password: 'Demo@123',
    description: 'Full Platform Access & Company Administration',
    color: 'border-purple-200 bg-purple-50/60 hover:bg-purple-100/70 text-purple-900',
  },
  {
    role: 'HR Manager',
    title: 'HR Manager (Priya Nair)',
    email: 'hr@peoplepay360.demo',
    password: 'Demo@123',
    description: 'Employees, Contracts, Working Schedules, Time Off & Approvals',
    color: 'border-amber-200 bg-amber-50/60 hover:bg-amber-100/70 text-amber-900',
  },
  {
    role: 'HR Payroll Manager',
    title: 'Payroll Manager (Rajesh Kumar)',
    email: 'payroll@peoplepay360.demo',
    password: 'Demo@123',
    description: 'Salary Structures, Rules Engine, Payrun Processing & Payslips',
    color: 'border-emerald-200 bg-emerald-50/60 hover:bg-emerald-100/70 text-emerald-900',
  },
  {
    role: 'Employee',
    title: 'Employee Hero (Kabir Singh)',
    email: 'employee@peoplepay360.demo',
    password: 'Demo@123',
    description: 'Self-Service: Profile, Contracts, Attendance, Approved Unpaid Leave & Payslips',
