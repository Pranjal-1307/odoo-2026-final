          ...
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <div className="relative" ref={timeOffRef}>
                ...
                {timeOffOpen && (
                  <div className="absolute left-0 mt-1.5 w-52 bg-white rounded-lg shadow-xl border border-slate-200 py-1.5 z-50">
              ...
              <div className="relative" ref={payrollRef}>
                ...
                {payrollOpen && (
                  <div className="absolute left-0 mt-1.5 w-56 bg-white rounded-lg shadow-xl border border-slate-200 py-1.5 z-50">
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                ...
                <div className="hidden sm:flex flex-col text-left">
                  <span className="text-xs font-semibold leading-tight">{user?.username || 'Demo User'}</span>
                  <span className="text-[10px] text-purple-200 leading-tight">{user?.role || 'Admin'}</span>
                </div>
                <ChevronDown className="w-3.5 h-3.5 text-purple-200" />
              </button>

              {userMenuOpen && (
                <div className="absolute right-0 mt-1.5 w-64 bg-white rounded-lg shadow-xl border border-slate-200 py-2 z-50">
                  <div className="px-4 py-2 border-b border-slate-100">
                    <p className="text-sm font-semibold text-slate-800">{user?.username || 'Admin User'}</p>
                    <p className="text-xs text-slate-500 truncate">{user?.email || 'admin@peoplepay360.com'}</p>
